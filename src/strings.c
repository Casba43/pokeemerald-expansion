...
const u8 gText_ExpandedPlaceholder_Aqua[] = _("CHOIR");
const u8 gText_ExpandedPlaceholder_Magma[] = _("VIGIL");
const u8 gText_ExpandedPlaceholder_Archie[] = _("THORNE");
const u8 gText_ExpandedPlaceholder_Maxie[] = _("RUE");
