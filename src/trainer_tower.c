...
static const struct TrainerEncounterMusicPairs sTrainerEncounterMusicLUT[] = {
    {FACILITY_CLASS_AQUA_GRUNT_F,           TRAINER_ENCOUNTER_MUSIC_CHOIR},
    ...
    {FACILITY_CLASS_BATTLE_GIRL,            TRAINER_ENCOUNTER_MUSIC_VIGIL},
    {FACILITY_CLASS_COLLECTOR,              TRAINER_ENCOUNTER_MUSIC_VIGIL},
    {FACILITY_CLASS_NINJA_BOY,              TRAINER_ENCOUNTER_MUSIC_VIGIL},
...
static const u16 sTrainerTowerEncounterMusic[] = {
    ...
    [TRAINER_ENCOUNTER_MUSIC_CHOIR]        = MUS_RG_ENCOUNTER_ROCKET,
    [TRAINER_ENCOUNTER_MUSIC_VIGIL]       = MUS_RG_ENCOUNTER_ROCKET,
