...
const u16 gTitleScreenBgPalettes[]         = INCBIN_U16("graphics/title_screen/pokemon_logo.gbapal",
                                                        "graphics/title_screen/night_sky.gbapal");
const u16 gTitleScreenCemeteryVersionPal[] = INCGFX_U16("graphics/title_screen/cemetery_version.png", ".gbapal");
...
const u32 gTitleScreenCemeteryVersionGfx[] = INCGFX_U32("graphics/title_screen/cemetery_version.png", ".8bpp.smol", "-mwidth 8 -mheight 4");
