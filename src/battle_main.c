...
const struct TrainerClass gTrainerClasses[TRAINER_CLASS_COUNT] =
{
    ...
    [TRAINER_CLASS_TEAM_CHOIR] = { _("TEAM CHOIR") },
    ...
    [TRAINER_CLASS_TEAM_VIGIL] = { _("TEAM VIGIL") },
    [TRAINER_CLASS_EXPERT] = { _("EXPERT"), 10 },
    [TRAINER_CLASS_CHOIR_ADMIN] = { _("CHOIR ADMIN"), 10 },
    [TRAINER_CLASS_BLACK_BELT] = { _("BLACK BELT"), 8, BALL_ULTRA },
    [TRAINER_CLASS_CHOIR_LEADER] = { _("CHOIR LEADER"), 20, BALL_MASTER },
...
static void HandleEndTurn_BattleWon(void)
{
    ...
    else if (gBattleTypeFlags & BATTLE_TYPE_TRAINER && !(gBattleTypeFlags & BATTLE_TYPE_LINK))
    {
        ...
        case TRAINER_CLASS_CHAMPION:
            ...
            break;
        case TRAINER_CLASS_TEAM_CHOIR:
        case TRAINER_CLASS_TEAM_VIGIL:
        case TRAINER_CLASS_CHOIR_ADMIN:
        case TRAINER_CLASS_CHOIR_LEADER:
        case TRAINER_CLASS_VIGIL_ADMIN:
        case TRAINER_CLASS_VIGIL_LEADER:
