...
static const struct MatchCallStructNPC sMrStoneMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_MrStone8,  FLAG_GROUDON_AWAKENED_VIGIL_HIDEOUT, NO_FLAG_TO_SET },
        { MatchCall_Text_MrStone9,  FLAG_TEAM_CHOIR_ESCAPED_IN_SUBMARINE, NO_FLAG_TO_SET },
...
static const struct MatchCallStructTrainer sYewMatchCallHeader =
{
    .type = MC_TYPE_LEADER,
    .mapSec = MAPSEC_PETALBURG_CITY,
    .flag = FLAG_ENABLE_YEW_MATCH_CALL,
    .rematchTableIdx = REMATCH_YEW,
    .desc = COMPOUND_STRING("THE MOURNER"),
    .name = COMPOUND_STRING("YEW"),
    .textData = (const match_call_text_data_t[]) {
        { MatchCall_Text_Yew1,                  FLAG_ENABLE_YEW_MATCH_CALL, NO_FLAG_TO_SET },
        { MatchCall_Text_Yew2,                  FLAG_DEFEATED_DEWFORD_GYM,     NO_FLAG_TO_SET },
        { MatchCall_Text_Yew3,                  FLAG_DEFEATED_LAVARIDGE_GYM,   NO_FLAG_TO_SET },
        { MatchCall_Text_Yew4,                  FLAG_DEFEATED_PETALBURG_GYM,   NO_FLAG_TO_SET },
        { MatchCall_Text_Yew5,                  FLAG_RECEIVED_RED_OR_BLUE_ORB, NO_FLAG_TO_SET },
        { MatchCall_Text_Yew_Preparing,         REMATCH_CALL_START,            NO_FLAG_TO_SET },
        { MatchCall_Text_Yew_PreparingPostGame, FLAG_SYS_GAME_CLEAR,           NO_FLAG_TO_SET },
        { MatchCall_Text_Yew_RematchReady,      FLAG_SYS_GAME_CLEAR,           NO_FLAG_TO_SET },
        { MatchCall_Text_Yew_PostRematch,       FLAG_SYS_GAME_CLEAR,           NO_FLAG_TO_SET },
        MATCH_CALL_TEXT_END
    }
};
...
static const struct MatchCallStructNPC sStevenMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Steven4, FLAG_TEAM_CHOIR_ESCAPED_IN_SUBMARINE, NO_FLAG_TO_SET },
...
static const struct MatchCallRival sMayMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_May10, FLAG_GROUDON_AWAKENED_VIGIL_HIDEOUT, NO_FLAG_TO_SET },
        { MatchCall_Text_May11, FLAG_MET_TEAM_CHOIR_HARBOR,           NO_FLAG_TO_SET },
        { MatchCall_Text_May12, FLAG_TEAM_CHOIR_ESCAPED_IN_SUBMARINE, NO_FLAG_TO_SET },
...
static const struct MatchCallRival sBrendanMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Brendan10, FLAG_GROUDON_AWAKENED_VIGIL_HIDEOUT, NO_FLAG_TO_SET },
        { MatchCall_Text_Brendan11, FLAG_MET_TEAM_CHOIR_HARBOR,           NO_FLAG_TO_SET },
        { MatchCall_Text_Brendan12, FLAG_TEAM_CHOIR_ESCAPED_IN_SUBMARINE, NO_FLAG_TO_SET },
...
static const struct MatchCallWally sWallyMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Wally5, FLAG_GROUDON_AWAKENED_VIGIL_HIDEOUT, NO_FLAG_TO_SET },
    ...
    .locationData = (const struct MatchCallLocationOverride[]) {
        ...
        { FLAG_GROUDON_AWAKENED_VIGIL_HIDEOUT,    MAPSEC_NONE },
...
static const struct MatchCallStructNPC sScottMatchCallHeader =
{
    ...
    .textData = (const match_call_text_data_t[]) {
        ...
        { MatchCall_Text_Scott5, FLAG_TEAM_CHOIR_ESCAPED_IN_SUBMARINE, NO_FLAG_TO_SET },
...
static const struct MatchCallStructTrainer sFlanneryMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("FLAME KEEPER"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const struct MatchCallStructTrainer sWinonaMatchCallHeader =
{
    ...
    .desc = COMPOUND_STRING("THE WATCHER"),
    .name = NULL,
    .textData = (const match_call_text_data_t[]) {
...
static const match_call_t sMatchCallHeaders[] = {
    ...
    [MC_HEADER_YEW]     = {.leader = &sYewMatchCallHeader},
