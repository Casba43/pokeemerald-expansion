...
#define VAR_CEMETERY_STATE                               0x4083 // Cemetery starting area (Emerald builds only)
#define VAR_BIRCH_LAB_STATE                              0x4084
#define VAR_PETALBURG_GYM_STATE                          0x4085 // 0-1: Wally tutorial, 2-6: 0-4 badges, 7: Defeated Yew, 8: Rematch Yew
