...
enum TrainerClassID
{
    ...
    TRAINER_CLASS_TEAM_VIGIL,
    TRAINER_CLASS_EXPERT,
    TRAINER_CLASS_CHOIR_ADMIN,
    TRAINER_CLASS_BLACK_BELT,
    TRAINER_CLASS_CHOIR_LEADER,
    ...
    TRAINER_CLASS_VIGIL_ADMIN,
    TRAINER_CLASS_RIVAL,
    TRAINER_CLASS_BUG_CATCHER,
    TRAINER_CLASS_PKMN_RANGER,
    TRAINER_CLASS_VIGIL_LEADER,
    TRAINER_CLASS_LASS,
...
#define TRAINER_ENCOUNTER_MUSIC_CHOIR         6
#define TRAINER_ENCOUNTER_MUSIC_VIGIL        7
