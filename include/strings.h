...
extern const u8 MatchCall_Text_Yew1[];
extern const u8 MatchCall_Text_Yew2[];
extern const u8 MatchCall_Text_Yew3[];
extern const u8 MatchCall_Text_Yew4[];
extern const u8 MatchCall_Text_Yew5[];
extern const u8 MatchCall_Text_Yew_Preparing[];
extern const u8 MatchCall_Text_Yew_PreparingPostGame[];
extern const u8 MatchCall_Text_Yew_RematchReady[];
extern const u8 MatchCall_Text_Yew_PostRematch[];
